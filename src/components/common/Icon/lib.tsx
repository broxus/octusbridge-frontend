...
const library = t({
    ...
    tvm1000BlockchainIcon: ({ ratio, ...props }) => {
        ...
        const gradient1Id = uniqueId()
        const gradient2Id = uniqueId()
        const gradient3Id = uniqueId()
        const gradient4Id = uniqueId()
        const gradient5Id = uniqueId()
        const gradient6Id = uniqueId()
        return (
            <svg {...defaultProps} {...props} viewBox="0 0 32 32" {...getSize(20, 20, ratio)}>
                ...
                <defs>
                    ...
                    >
                        ...
                        <feGaussianBlur
                            stdDeviation="5"
                            result="effect1_foregroundBlur_10890_5345"
                        />
                    </filter>
                    <filter
                        id={gradient6Id}
    ...
    evm56BlockchainIcon: ({ ratio, ...props }) => (
        <svg {...defaultProps} {...props} viewBox="0 0 34 40" {...getSize(20, 20, ratio)}>
            <path className="uk-preserve" d="M17 0L6.56211 6.12683L10.3996 8.39024L17 4.52683L23.6004 8.39024L27.4379 6.12683L17 0Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M23.6004 11.5902L27.4379 13.8537V18.3805L20.8375 22.2439V29.9707L17 32.2341L13.1625 29.9707V22.2439L6.56211 18.3805V13.8537L10.3996 11.5902L17 15.4537L23.6004 11.5902Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M27.4379 21.5805V26.1073L23.6004 28.3707V23.8439L27.4379 21.5805Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M23.5621 31.5707L30.1625 27.7073V19.9805L34 17.7171V29.9707L23.5621 36.0976V31.5707Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M30.1625 12.2537L26.3251 9.99025L30.1625 7.72683L34 9.99025V14.5171L30.1625 16.7805V12.2537Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M13.1625 37.7366V33.2098L17 35.4732L20.8375 33.2098V37.7366L17 40L13.1625 37.7366Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M10.3996 28.3707L6.56211 26.1073V21.5805L10.3996 23.8439V28.3707Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M17 12.2537L13.1625 9.99025L17 7.72683L20.8375 9.99025L17 12.2537Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M7.67493 9.99025L3.83747 12.2537V16.7805L0 14.5171V9.99025L3.83747 7.72683L7.67493 9.99025Z" fill="#F0B90B"/>
            <path className="uk-preserve" d="M0 17.7171L3.83747 19.9805V27.7073L10.4379 31.5707V36.0976L0 29.9707V17.7171Z" fill="#F0B90B"/>
        </svg>
    ),
    ...
    metamaskWalletIcon: ({ ratio, ...props }) => <svg {...defaultProps} {...props} viewBox="0 0 35 33" {...getSize(33, 35, ratio)}><g strokeLinecap="round" strokeLinejoin="round" strokeWidth=".25"><path d="m32.9582 1-13.1341 9.7183 2.4424-5.72731z" className="uk-preserve" fill="#e17726" stroke="#e17726"/><g className="uk-preserve" fill="#e27625" stroke="#e27625"><path d="m2.66296 1 13.01714 9.809-2.3254-5.81802z"/><path d="m28.2295 23.5335-3.4947 5.3386 7.4829 2.0603 2.1436-7.2823z"/><path d="m1.27281 23.6501 2.13055 7.2823 7.46994-2.0603-3.48166-5.3386z"/><path d="m10.4706 14.5149-2.0786 3.1358 7.405.3369-.2469-7.969z"/><path d="m25.1505 14.5149-5.1575-4.58704-.1688 8.05974 7.4049-.3369z"/><path d="m10.8733 28.8721 4.4819-2.1639-3.8583-3.0062z"/><path d="m20.2659 26.7082 4.4689 2.1639-.6105-5.1701z"/></g><path d="m24.7348 28.8721-4.469-2.1639.3638 2.9025-.039 1.231z" className="uk-preserve" fill="#d5bfb2" stroke="#d5bfb2"/><path d="m10.8732 28.8721 4.1572 1.9696-.026-1.231.3508-2.9025z" className="uk-preserve" fill="#d5bfb2" stroke="#d5bfb2"/><path d="m15.1084 21.7842-3.7155-1.0884 2.6243-1.2051z" className="uk-preserve" fill="#233447" stroke="#233447"/><path d="m20.5126 21.7842 1.0913-2.2935 2.6372 1.2051z" className="uk-preserve" fill="#233447" stroke="#233447"/><path d="m10.8733 28.8721.6495-5.3386-4.13117.1167z" className="uk-preserve" fill="#cc6228" stroke="#cc6228"/><path d="m24.0982 23.5335.6366 5.3386 3.4946-5.2219z" className="uk-preserve" fill="#cc6228" stroke="#cc6228"/><path d="m27.2291 17.6507-7.405.3369.6885 3.7966 1.0913-2.2935 2.6372 1.2051z" className="uk-preserve" fill="#cc6228" stroke="#cc6228"/><path d="m11.3929 20.6958 2.6242-1.2051 1.0913 2.2935.6885-3.7966-7.40495-.3369z" className="uk-preserve" fill="#cc6228" stroke="#cc6228"/><path d="m8.392 17.6507 3.1049 6.0513-.1039-3.0062z" className="uk-preserve" fill="#e27525" stroke="#e27525"/><path d="m24.2412 20.6958-.1169 3.0062 3.1049-6.0513z" className="uk-preserve" fill="#e27525" stroke="#e27525"/><path d="m15.797 17.9876-.6886 3.7967.8704 4.4833.1949-5.9087z" className="uk-preserve" fill="#e27525" stroke="#e27525"/><path d="m19.8242 17.9876-.3638 2.3584.1819 5.9216.8704-4.4833z" className="uk-preserve" fill="#e27525" stroke="#e27525"/><path d="m20.5127 21.7842-.8704 4.4834.6236.4406 3.8584-3.0062.1169-3.0062z" className="uk-preserve" fill="#f5841f" stroke="#f5841f"/><path d="m11.3929 20.6958.104 3.0062 3.8583 3.0062.6236-.4406-.8704-4.4834z" className="uk-preserve" fill="#f5841f" stroke="#f5841f"/><path d="m20.5906 30.8417.039-1.231-.3378-.2851h-4.9626l-.3248.2851.026 1.231-4.1572-1.9696 1.4551 1.1921 2.9489 2.0344h5.0536l2.962-2.0344 1.442-1.1921z" className="uk-preserve" fill="#c0ac9d" stroke="#c0ac9d"/><path d="m20.2659 26.7082-.6236-.4406h-3.6635l-.6236.4406-.3508 2.9025.3248-.2851h4.9626l.3378.2851z" className="uk-preserve" fill="#161616" stroke="#161616"/><path d="m33.5168 11.3532 1.1043-5.36447-1.6629-4.98873-12.6923 9.3944 4.8846 4.1205 6.8983 2.0085 1.52-1.7752-.6626-.4795 1.0523-.9588-.8054-.622 1.0523-.8034z" className="uk-preserve" fill="#763e1a" stroke="#763e1a"/><path d="m1 5.98873 1.11724 5.36447-.71451.5313 1.06527.8034-.80545.622 1.05228.9588-.66255.4795 1.51997 1.7752 6.89835-2.0085 4.8846-4.1205-12.69233-9.3944z" className="uk-preserve" fill="#763e1a" stroke="#763e1a"/><path d="m32.0489 16.5234-6.8983-2.0085 2.0786 3.1358-3.1049 6.0513 4.1052-.0519h6.1318z" className="uk-preserve" fill="#f5841f" stroke="#f5841f"/><path d="m10.4705 14.5149-6.89828 2.0085-2.29944 7.1267h6.11883l4.10519.0519-3.10487-6.0513z" className="uk-preserve" fill="#f5841f" stroke="#f5841f"/><path d="m19.8241 17.9876.4417-7.5932 2.0007-5.4034h-8.9119l2.0006 5.4034.4417 7.5932.1689 2.3842.013 5.8958h3.6635l.013-5.8958z" className="uk-preserve" fill="#f5841f" stroke="#f5841f"/></g></svg>,
    ...
    solana1BlockchainIcon: ({ ratio, ...props }) => {
        ...
        return (
            <svg {...defaultProps} {...props} viewBox="0 0 397.7 311.7" {...getSize(20, 20, ratio)}>
                <linearGradient id={`paint0_linear_127_${gradient1Id}`} gradientUnits="userSpaceOnUse" x1="360.8791" y1="351.4553" x2="141.213" y2="-69.2936" gradientTransform="matrix(1 0 0 -1 0 314)">
                    <stop offset="0" stopColor="#00FFA3"/>
                    <stop offset="1" stopColor="#DC1FFF"/>
                </linearGradient>
                <path fill={`url(#paint0_linear_127_${gradient1Id})`} d="M64.6,237.9c2.4-2.4,5.7-3.8,9.2-3.8h317.4c5.8,0,8.7,7,4.6,11.1l-62.7,62.7c-2.4,2.4-5.7,3.8-9.2,3.8H6.5c-5.8,0-8.7-7-4.6-11.1L64.6,237.9z"/>
                <linearGradient id={`paint0_linear_127_${gradient2Id}`} gradientUnits="userSpaceOnUse" x1="264.8291" y1="401.6014" x2="45.163" y2="-19.1475" gradientTransform="matrix(1 0 0 -1 0 314)">
                    <stop offset="0" stopColor="#00FFA3"/>
                    <stop offset="1" stopColor="#DC1FFF"/>
                </linearGradient>
                <path fill={`url(#paint0_linear_127_${gradient2Id})`} d="M64.6,3.8C67.1,1.4,70.4,0,73.8,0h317.4c5.8,0,8.7,7,4.6,11.1l-62.7,62.7c-2.4,2.4-5.7,3.8-9.2,3.8H6.5c-5.8,0-8.7-7-4.6-11.1L64.6,3.8z"/>
                <linearGradient id={`paint0_linear_127_${gradient3Id}`} gradientUnits="userSpaceOnUse" x1="312.5484" y1="376.688" x2="92.8822" y2="-44.061" gradientTransform="matrix(1 0 0 -1 0 314)">
                    <stop offset="0" stopColor="#00FFA3"/>
                    <stop offset="1" stopColor="#DC1FFF"/>
                </linearGradient>
                <path fill={`url(#paint0_linear_127_${gradient3Id})`} d="M333.1,120.1c-2.4-2.4-5.7-3.8-9.2-3.8H6.5c-5.8,0-8.7,7-4.6,11.1l62.7,62.7c2.4,2.4,5.7,3.8,9.2,3.8h317.4c5.8,0,8.7-7,4.6-11.1L333.1,120.1z"/>
            </svg>
        )
    },
