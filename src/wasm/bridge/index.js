...
export function initializeMint(funder_pubkey, initializer_pubkey, name, ever_decimals, solana_decimals, deposit_limit, withdrawal_limit, withdrawal_daily_limit) {
    try {
        ...
        const len2 = WASM_VECTOR_LEN;
        wasm.initializeMint(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ever_decimals, solana_decimals, deposit_limit, withdrawal_limit, withdrawal_daily_limit);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function initializeVault(funder_pubkey, initializer_pubkey, mint_pubkey, name, ever_decimals, deposit_limit, withdrawal_limit, withdrawal_daily_limit) {
    try {
        ...
        const len3 = WASM_VECTOR_LEN;
        wasm.initializeVault(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ever_decimals, deposit_limit, withdrawal_limit, withdrawal_daily_limit);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function withdrawalRequest(funder_pubkey, author_pubkey, name, event_timestamp, event_transaction_lt, event_configuration, sender_address, recipient_address, amount, round_number) {
    try {
        ...
        const ptr2 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(event_configuration, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        ...
        wasm.withdrawalRequest(retptr, ptr0, len0, ptr1, len1, ptr2, len2, event_timestamp, event_transaction_lt, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, round_number);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function depositEver(funder_pubkey, authority_pubkey, author_token_pubkey, name, deposit_seed, recipient_address, amount) {
    try {
        ...
        const ptr5 = passStringToWasm0(recipient_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len5 = WASM_VECTOR_LEN;
        wasm.depositEver(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, amount);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function depositSol(funder_pubkey, author_pubkey, mint_pubkey, author_token_pubkey, name, deposit_seed, recipient_address, amount) {
    try {
        ...
        const len6 = WASM_VECTOR_LEN;
        wasm.depositSol(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, amount);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function changeBounty(author_pubkey, withdrawal_pubkey, bounty) {
    try {
        ...
        const ptr1 = passStringToWasm0(withdrawal_pubkey, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.changeBounty(retptr, ptr0, len0, ptr1, len1, bounty);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function changeDepositLimit(authority_pubkey, name, new_deposit_limit) {
    try {
        ...
        const ptr1 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.changeDepositLimit(retptr, ptr0, len0, ptr1, len1, new_deposit_limit);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function changeWithdrawalLimits(authority_pubkey, name, new_withdrawal_limit, new_withdrawal_daily_limit) {
    try {
        ...
        const ptr1 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.changeWithdrawalLimits(retptr, ptr0, len0, ptr1, len1, !isLikeNone(new_withdrawal_limit), isLikeNone(new_withdrawal_limit) ? 0n : new_withdrawal_limit, !isLikeNone(new_withdrawal_daily_limit), isLikeNone(new_withdrawal_daily_limit) ? 0n : new_withdrawal_daily_limit);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function getProposalAddress(token_settings, round_number, event_timestamp, event_transaction_lt, event_configuration, sender_address, recipient_address, amount) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(event_configuration, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(sender_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(recipient_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(amount, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        wasm.getProposalAddress(retptr, ptr0, len0, round_number, event_timestamp, event_transaction_lt, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
