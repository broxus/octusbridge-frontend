        ...
        <>
            ...
            {(() => {
                if (
                    ...
                    return (
                        <li key="left-tokeт-1">
                            <div className="text-muted">{summary.leftNetwork?.label}</div>
                            <div>
                                {!evmTokenAddress ? (
                                    <Skeleton width={60} />
                                ) : (
                        ...
                        <li key="left-tokeт-2">
                            ...
                            <div>
                                {!everscaleTokenAddress ? (
                                    ...
                                    <EverAsset key="token-link" address={everscaleTokenAddress.toString()} />
                                )}
                            </div>
                        </li>
                    )
            ...
            {(() => {
                if ((isLeftEvm && isRightEvm) || (isRightEvm && !isNativeEvmCurrency)) {
                    return (
                        <li key="right-toke-1">
                            <div className="text-muted">{summary.rightNetwork?.label}</div>
                            <div>
                                {!evmTokenAddress ? (
                                    <Skeleton width={60} />
                                ) : (
                                    <BlockScanAddressLink
                                        ...
                                        onAddAsset={addToEvmAsset(
                                            evmTokenAddress,
                                            summary.isEvmEvm ? summary.secondPipeline : summary.pipeline,
                                        )}
                                    >
                                        {sliceAddress(
                                            summary.isEvmEvm
