...
import type { EvmEverscalePipelineData, EvmEverscalePipelineState } from '@/modules/Bridge/stores/EvmEverscalePipeline'
...
import type { BridgeAssetsService, BridgeAssetUniqueKey } from '@/stores/BridgeAssetsService'
...
export type EvmEverscaleCreditPipelineData = EvmEverscalePipelineData & {
    creditProcessorAddress?: Address;
}

export type EvmEverscaleCreditPipelineState = {
    creditProcessorState?: CreditProcessorState;
    eventState?: EvmEverscalePipelineState['eventState'];
    ...
    transferState?: EvmEverscalePipelineState['transferState'];
    swapState?: {
        deployer?: Address;
        errorMessage?: string;
        isCanceling?: boolean;
...
export class EvmEverscaleCreditPipeline<
    T extends EvmEverscaleCreditPipelineData | Record<string, any> = EvmEverscaleCreditPipelineData,
    U extends EvmEverscaleCreditPipelineState | Record<string, any> = EvmEverscaleCreditPipelineState
> extends BaseStore<T, U> {
    ...
    public async process(): Promise<void> {
        ...
        try {
            ...
            this.setState('swapState', {
                ...this.swapState,
                isStuck: false,
            }as EvmEverscaleCreditPipelineState['swapState'])
        }
        catch (e) {
            this.setState('swapState', {
                ...this.swapState,
    ...
    protected runTransferUpdater(): void {
        ...
        (async () => {
            ...
            const transferState: EvmEverscaleCreditPipelineState['transferState'] = {
    ...
    protected runCreditProcessorUpdater(): void {
        ...
        (async () => {
            ...
            if (isCancelled || isProcessed) {
                ...
                const swapState: EvmEverscaleCreditPipelineState['swapState'] = {
                    ...this.swapState,
            ...
            if (state >= CreditProcessorState.EventDeployInProgress) {
                ...
                if (this.eventState?.status !== 'confirmed' && this.eventState?.status !== 'rejected') {
                    ...
                    const eventState: EvmEverscaleCreditPipelineState['eventState'] = {
    ...
    public get amount(): EvmEverscaleCreditPipelineData['amount'] {
        return this.data.amount
    }

    public get pipeline(): EvmEverscaleCreditPipelineData['pipeline'] {
        return this.data.pipeline
    }

    public get creditProcessorAddress(): EvmEverscaleCreditPipelineData['creditProcessorAddress'] {
        return this.data.creditProcessorAddress
    }

    public get deriveEventAddress(): EvmEverscaleCreditPipelineData['deriveEventAddress'] {
        return this.data.deriveEventAddress
    }

    public get leftAddress(): EvmEverscaleCreditPipelineData['leftAddress'] {
        return this.data.leftAddress
    }

    public get rightAddress(): EvmEverscaleCreditPipelineData['rightAddress'] {
        return this.data.rightAddress
    }

    public get token(): EvmEverscaleCreditPipelineData['token'] {
        return this.data.token
    }

    public get creditProcessorState(): EvmEverscaleCreditPipelineState['creditProcessorState'] {
        return this.state.creditProcessorState
    }

    public get eventState(): EvmEverscaleCreditPipelineState['eventState'] {
        return this.state.eventState
    }

    public get prepareState(): EvmEverscaleCreditPipelineState['prepareState'] {
        return this.state.prepareState
    }

    public get swapState(): EvmEverscaleCreditPipelineState['swapState'] {
        return this.state.swapState
    }

    public get transferState(): EvmEverscaleCreditPipelineState['transferState'] {
    ...
    public get depositType(): EvmTransferUrlParams['depositType'] | undefined {
